...
enum Tickers : uint32_t {
  ...
  SCAN_FUSE_CURSOR_HIT,
  SCAN_FUSE_CURSOR_MISS,
  SCAN_FUSE_CURSOR_FALLBACK,
  SCAN_FUSE_CURSOR_ADVANCE,
  SCAN_FUSE_CURSOR_EVICTION,
  SCAN_FUSE_CURSOR_BYPASS,
  SCAN_FUSE_LANE_GRANT,
