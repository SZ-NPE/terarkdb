...
const std::vector<std::pair<Tickers, std::string>> TickersNameMap = {
    ...
    {GC_READ_BYTES, "rocksdb.gc.read.bytes"},
    {GC_WRITE_BYTES, "rocksdb.gc.write.bytes"},
    {GC_CLEAR_BYTES, "rocksdb.gc.clear.bytes"},
    {GC_INPUT_FILES, "rocksdb.gc.input.files.bytes"},
    {GC_OUTPUT_FILES, "rocksdb.gc.output.files.bytes"},
    ...
    {GC_INDEX_MAP_LOAD_BYTES, "lavakv.gc.index.map.load.bytes"},
    {GC_INDEX_MAP_LOAD_COUNT, "lavakv.gc.index.map.load.count"},
    ...
    {GC_READ_BYTES, "lavakv.gc.read.bytes"},
    {GC_WRITE_BYTES, "lavakv.gc.write.bytes"},
    {GC_GETKEY_READ_BYTES, "lavakv.gc.getkey.read.bytes"},
    ...
    {INDEX_KEY_MAP_FOUND, "lavakv.index.key.map.found"},
    ...
    {BLOCK_CACHE_MISS_GC_READ, "rocksdb.block.cache.miss.gc.read"},
    {HOT_BLOB_VALUE_ENTRY, "lavakv.hot.blob.value.entry"},
    {COLD_BLOB_VALUE_ENTRY, "lavakv.cold.blob.value.entry"},
    {HOT_BLOB_FILE_NUM, "lavakv.hot.blob.file.num"},
    {COLD_BLOB_FILE_NUM, "lavakv.cold.blob.file.num"},
...
const std::vector<std::pair<Histograms, std::string>> HistogramsNameMap = {
    ...
    {INIT_DATA_BLOCK_TIME, "lavakv.iter.init.data.block.micros"},
    {INIT_INDEX_KEY_BLOCK_TIME, "lavakv.iter.init.index.key.block.micros"},
    {SEEK_TO_FIRST_TIME, "lavakv.iter.seektofirst.micros"},
    {SEEK_TIME, "lavakv.iter.seek.micros"},
    {NEXT_TIME, "lavakv.iter.next.time"},
