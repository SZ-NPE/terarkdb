...
const std::vector<std::pair<Tickers, std::string>> TickersNameMap = {
    ...
    {GC_DROP_KEY_CACHE_HIT, "rocksdb.num.gc.drop_key_cache_hit"},
    {GC_DROP_KEY_CACHE_MISS, "rocksdb.num.gc.drop_key_cache_miss"},
    {GC_GET_KEY_AVOIDED, "rocksdb.num.gc.get_key_avoided"},
    {HOTNESS_FLUSH_HOT_KEYS, "rocksdb.num.hotness.flush.hot_keys"},
    {HOTNESS_FLUSH_WARM_KEYS, "rocksdb.num.hotness.flush.warm_keys"},
    {HOTNESS_FLUSH_COLD_KEYS, "rocksdb.num.hotness.flush.cold_keys"},
    {HOTNESS_FLUSH_HOT_BYTES, "rocksdb.bytes.hotness.flush.hot"},
    {HOTNESS_FLUSH_WARM_BYTES, "rocksdb.bytes.hotness.flush.warm"},
    {HOTNESS_FLUSH_COLD_BYTES, "rocksdb.bytes.hotness.flush.cold"},
    {GC_PICK_CANDIDATE_FILES, "rocksdb.num.gc.pick.candidate_files"},
    {GC_PICK_SELECTED_FILES, "rocksdb.num.gc.pick.selected_files"},
    {GC_PICK_SELECTED_BYTES, "rocksdb.bytes.gc.pick.selected"},
    {GC_PICK_SELECTED_GARBAGE_BYTES, "rocksdb.bytes.gc.pick.selected_garbage"},
    {GC_PICK_SELECTED_LIVE_BYTES, "rocksdb.bytes.gc.pick.selected_live"},
    {GC_VSST_READ_BYTES, "rocksdb.bytes.gc.vsst_read"},
    ...
    {CF_GC_WRITE_BYTES, "rocksdb.cf.gc.write.bytes"},
    {CF_GC_READ_BYTES, "rocksdb.cf.gc.read.bytes"},
    {CF_GC_CLEAR_BYTES, "rocksdb.cf.gc.clear.bytes"},
    {CF_GC_ANTIQUATED_ENTRY_PERMIL,
     "rocksdb.cf.permil.antiquated_entry_in_gc"},
    {CF_GC_ANTIQUATED_BYTES_PERMIL,
     "rocksdb.cf.permil.antiquated_size_in_gc"},
