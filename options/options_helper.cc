...
std::unordered_map<std::string, OptionTypeInfo>
    OptionsHelper::cf_options_type_info = {
        ...
        {"enable_hot_key_write_buffer",
         {offset_of(&ColumnFamilyOptions::enable_hot_key_write_buffer),
          OptionType::kBoolean, OptionVerificationType::kNormal, false, 0}},
        {"hot_key_write_buffer_size",
         {offset_of(&ColumnFamilyOptions::hot_key_write_buffer_size),
          OptionType::kSizeT, OptionVerificationType::kNormal, false, 0}},
        {"hot_key_admission_threshold",
         {offset_of(&ColumnFamilyOptions::hot_key_admission_threshold),
          OptionType::kUInt32T, OptionVerificationType::kNormal, false, 0}},
        {"hot_key_sketch_columns",
         {offset_of(&ColumnFamilyOptions::hot_key_sketch_columns),
          OptionType::kUInt32T, OptionVerificationType::kNormal, false, 0}},
        {"hot_key_sketch_decay_interval",
         {offset_of(&ColumnFamilyOptions::hot_key_sketch_decay_interval),
          OptionType::kUInt64T, OptionVerificationType::kNormal, false, 0}},
        {"hot_key_max_buffered_value_size",
         {offset_of(&ColumnFamilyOptions::hot_key_max_buffered_value_size),
          OptionType::kSizeT, OptionVerificationType::kNormal, false, 0}},
        {"filter_deletes",
         {0, OptionType::kBoolean, OptionVerificationType::kDeprecated, true,
          0}},
