  ...
  *bbto = BlockBasedTableOptions();
  ...
  ASSERT_OK(GetBlockBasedTableOptionsFromString(
      *bbto,
      ...
      "use_separated_value_meta_block=true;"
  ...
  *options = DBOptions();
  ...
  ASSERT_OK(
      GetDBOptionsFromString(*options,
                             ...
                             "blob_gc_collect_block_stats=true;"
                             "blob_gc_collect_latency_stats=true;"
                             "blob_gc_collect_bytes_stats=true;"
                             "blob_gc_diagnostics=true;"
                              "block_cache_obsolete_tracking=true;"
                              "block_cache_obsolete_sample_interval_sec=30;"
  ...
  *options = ColumnFamilyOptions();
  ...
  ASSERT_OK(GetColumnFamilyOptionsFromString(
      *options,
      ...
      "hotness_admit_threshold=3;"
      "hotness_decay_interval=100;"
      "hotness_decay_window=5;"
      "blob_gc_ratio=0.05;"
      "precise_gc=false;"
