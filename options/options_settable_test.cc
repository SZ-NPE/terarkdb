  ...
  *options = ColumnFamilyOptions();
  ...
  ASSERT_OK(GetColumnFamilyOptionsFromString(
      *options,
      ...
      "hotness_window_capacity=123456;"
      "hotness_hot_capacity=654321;"
      "hotness_enable_write_window=true;"
      "hotness_enable_compaction_feedback=true;"
      "hotness_sketch_width=4194304;"
      "hotness_sketch_depth=4;"
      "hotness_write_repeat_weight=1;"
      "hotness_compaction_feedback_weight=2;"
      "hotness_threshold=2;"
      "hotness_decay_interval=1000000;"
      "hotness_half_life_writes=6500000;"
      "blob_gc_ratio=0.05;"
      "precise_gc=false;"
      "enable_blob_death_log=true;"
      "blob_death_log_persist=false;"
      "blob_death_log_buffer_size=67108864;"
      "blob_gc_skip_dead_blocks=true;"
      "blob_gc_skip_getkey_with_deathmap=true;"
